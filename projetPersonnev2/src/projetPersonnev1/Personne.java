...
public class Personne {
	...
	Personne() { // =constructeur par defaut car zero méthode, quand il y a void
					// c est une methode, prend à l identique le nom de la classe	
	}

	Personne(String nom, String prenom) {// constructeur d initialisation
		this.nom =nom;
		this.prenom= prenom; //this renvoi à un attribu
	}
